...
{
    public delegate void OnRoomsReceived(StarBossRoomAvailable[] rooms);
    ...
    public IndexedDictionary<string, ExampleNetworkedEntityView> GetEntityViews()
    {
        return _roomController.EntityViews;
    }
    ...
    public Dictionary<string, object> RoomOptions
    {
        get
        {
            return _roomController.RoomOptions;
        }
    }
    ...
    public IndexedDictionary<string, ExampleNetworkedEntity> Entities
    {
        get
        {
            return _roomController.Entities;
        }
    }
    ...
    public void Initialize(string roomName, Dictionary<string, object> roomOptions)
    {
        ...
        LSLog.LogImportant($"Example Manager - Initialize");
    ...
    public void JoinOrCreateRoom(Dictionary<string, object> roomOptions)
    {
        _roomController.SetRoomOptions(roomOptions);
        JoinOrCreateRoom();
    }
